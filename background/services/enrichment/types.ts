...
export type EnrichedPOKTTransaction = AnyPOKTTransaction & {
  annotation?: TransactionAnnotation | undefined
}
...
export type EnrichedPOKTTransactionSignatureRequest = POKTTransactionRequest & {
  annotation?: TransactionAnnotation
}
...
export type EnrichedPOKTTransactionRequest = POKTTransactionRequest & {
  annotation?: TransactionAnnotation
}
