        ...
        <div className="relative flex flex-col items-center group">
          ...
          <div className="absolute bottom-0 flex-col items-center hidden mb-6 group-hover:flex">
            <span className="relative z-10 p-2 text-xs leading-none text-white whitespace-no-wrap bg-gray-600 shadow-lg rounded-md text-center ">
              Representative of net rewards after fees. <br />
              Past performance is no guarantee of future rewards. <br />
              Real rewards fluctuate due to a number of factors including <br />
              the network, the number of compounding events, and the <br />
              user.
            </span>
