...
/**
 * The Blocknative class wraps access to the Blocknative API for the PoktWallet
 * extension backend. It exposes PoktWallet-specific functionality, and manages
