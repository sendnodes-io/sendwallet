...
export default class ChainService extends BaseService<Events> {
  ...
  async populatePartialEVMTransactionRequest(
    ...
    try {
      ...
      if (error instanceof Error) {
        // rome-ignore lint/suspicious/noExplicitAny: Ethers does some heavily loose typing around errors to carry arbitrary info without subclassing Error, so an any cast is needed.
  ...
  ): Promise<EIP1559TransactionRequest & { nonce: number | undefined }> {
